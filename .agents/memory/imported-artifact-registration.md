...
**How to apply:** Check the registered artifact list after an import; if the imported app is absent, register it before starting or restarting its managed web service.