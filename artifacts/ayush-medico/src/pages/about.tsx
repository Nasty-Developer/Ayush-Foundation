...
export default function AboutPage() {
  return (
    <PageFrame eyebrow="About Ayush Medico" title="A pharmacy with a familiar face." description="Ayush Medico is a modern neighbourhood pharmacy grounded in an old-fashioned idea: good care starts with listening.">
